    ...
    <div>
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-2.5">
        <div className="max-w-7xl mx-auto text-xs text-gray-500 flex items-center gap-1.5">
          ...
          <span>Co robimy</span>
          <span>›</span>
          <span className="text-gray-900 font-medium">Magazyny energii BESS</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-3xl font-bold leading-snug mb-4">
              Magazyny energii BESS — projektowanie i budowa
            </h1>
            <p className="text-gray-300 text-base mb-6">
              Battery Energy Storage Systems — systemy bateryjne zwiększające efektywność,
              stabilność i niezależność energetyczną instalacji OZE.
            </p>
          ...
          <ImagePlaceholder label="Kontener BESS — system bateryjny na terenie instalacji" aspectRatio="4/3" className="opacity-80" />
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-sm text-gray-500 mb-8">
          Przygotowujemy szczegółowy opis oferty BESS — zakres projektowania, dobór technologii,
          integracja z instalacją PV i siecią energetyczną.
        </p>
        <Annotation>
          Docelowa struktura analogiczna do strony Farmy PV: typy magazynów, proces EPC, zakres techniczny, FAQ, realizacje.
        </Annotation>
        <Link
          to="/kontakt"
